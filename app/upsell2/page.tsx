...
const PRICE = 24.90
const TITLE = "Shampoo Automotivo Concentrado 5L"
const NEXT  = "/upsell3"
...
export default function Upsell2Page() {
  ...
  return (
    <div style={{ minHeight: "100vh", backgroundColor: "#f0f9ff", fontFamily: "sans-serif" }}>
      <div style={{ backgroundColor: "#1d4ed8", color: "#fff", textAlign: "center", padding: "10px 16px", fontSize: "14px", fontWeight: 600 }}>
        ⚡ ÚLTIMA CHANCE — Oferta expira em: {mins}:{secs}
      </div>
        ...
        {view === "offer" && (
          <>
            <div style={{ textAlign: "center", marginBottom: "16px" }}>
              <span style={{ backgroundColor: "#dbeafe", color: "#1e40af", padding: "6px 16px", borderRadius: "20px", fontSize: "13px", fontWeight: 700, border: "1px solid #93c5fd" }}>
                🧴 OFERTA ESPECIAL Nº 2
              </span>
            </div>

            <h1 style={{ textAlign: "center", fontSize: "22px", fontWeight: 800, color: "#111827", marginBottom: "8px", lineHeight: 1.3 }}>
              Shampoo Automotivo Concentrado 5L
            </h1>
            <p style={{ textAlign: "center", fontSize: "14px", color: "#6b7280", marginBottom: "20px" }}>
              Rende até 500 lavagens — fórmula profissional que remove gordura, sujeira e mau cheiro
            </p>

            <div style={{ backgroundColor: "#fff", border: "2px solid #1d4ed8", borderRadius: "12px", padding: "20px", marginBottom: "20px", textAlign: "center" }}>
              ...
              <h2 style={{ fontSize: "18px", fontWeight: 700, color: "#111827", marginBottom: "8px" }}>Shampoo Pro Concentrado 5L</h2>
              <ul style={{ textAlign: "left", fontSize: "14px", color: "#374151", paddingLeft: "20px", marginBottom: "16px" }}>
                <li>Fórmula concentrada — 1 tampa por lavagem</li>
                <li>Remove gordura, fumaça e insetos</li>
                <li>pH neutro, não danifica a pintura</li>
                <li>Ideal para uso com lavadora de pressão</li>
              </ul>
              <div style={{ marginBottom: "4px" }}>
                <span style={{ fontSize: "13px", color: "#9ca3af", textDecoration: "line-through" }}>De R$ 64,90</span>
              </div>
              <div>
                <span style={{ fontSize: "28px", fontWeight: 800, color: "#dc2626" }}>R$ {PRICE.toFixed(2).replace(".", ",")}</span>
                <span style={{ fontSize: "13px", color: "#16a34a", marginLeft: "8px", fontWeight: 600 }}>-62%</span>
              </div>
              <div style={{ fontSize: "12px", color: "#6b7280", marginTop: "4px" }}>Enviado junto com sua lavadora</div>
            </div>
            ...
            <button onClick={handleAccept} disabled={loading} style={{ width: "100%", padding: "16px", backgroundColor: loading ? "#9ca3af" : "#1d4ed8", color: "#fff", border: "none", borderRadius: "10px", fontSize: "17px", fontWeight: 700, cursor: loading ? "not-allowed" : "pointer", marginBottom: "12px", boxShadow: loading ? "none" : "0 4px 12px rgba(29,78,216,0.4)" }}>
            ...
            <button onClick={skip} style={{ width: "100%", padding: "12px", backgroundColor: "transparent", color: "#9ca3af", border: "1px solid #e5e7eb", borderRadius: "8px", fontSize: "13px", cursor: "pointer" }}>
              Não obrigado, continuar sem o shampoo
            </button>
          </>
        )}
